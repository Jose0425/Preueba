...
Public Class frmVentas
    ...
    Private Sub frmVentas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DbSql = New SqlConnection("Data Source=DESKTOP-7PS7I8B\SQLEXPRESS;Initial Catalog=PIZZERIA;Integrated Security=True")
        DbSql.Open()
        GeneraTabladeVenta()
    End Sub
    ...
    Private Sub gpbBuscaProducto_Enter(sender As Object, e As EventArgs) Handles gpbBuscaProducto.Enter
